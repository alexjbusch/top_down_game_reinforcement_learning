...
def get_args():
    ...
    parser.add_argument("--num_decay_epochs", type=float, default=5000000)
    parser.add_argument("--num_epochs", type=int, default=300000)
    parser.add_argument("--save_interval", type=int, default=250)
    parser.add_argument("--replay_memory_size", type=int, default=301,
...
def train(opt):
    ...
    while epoch < opt.num_epochs:
        ...
        reward, done = env.step(action, angle_dict = angle_dict)
